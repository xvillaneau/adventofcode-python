...
def test_day_14():
    ...
    assert next(day_14(example_2)) == 165
    assert tuple(day_14(example_3)) == (13312, 82892753)
    assert tuple(day_14(example_4)) == (180697, 5586022)
    assert tuple(day_14(example_5)) == (2210736, 460664)
